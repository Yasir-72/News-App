...
import 'package:news_app/view/screens/fullnewspage.dart'; // NewsService is assumed to be in this file.
...
class _ExplorePageState extends State<ExplorePage> {
  ...
  void _fetchDefaultNews() {
    _newsFuture = _newsService.fetchTopHeadlines("general", "us");
  }
  ...
  void _searchNews(String query) {
    setState(() {
      _newsFuture = query.isNotEmpty
          ...
          : _newsService.fetchTopHeadlines("general", "us");
    });
  }
  ...
  Widget _buildArticleItem(NewsArticle article) {
    {
      return GestureDetector(
        onTap: () {
          Navigator.push(context,MaterialPageRoute(builder: (context)=>FullNewsPage(imageUrl: article.imageUrl, title: article.title, description: article.description, content: article.content)));
        },
        child: Padding(
